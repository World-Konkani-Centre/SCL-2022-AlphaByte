# Generated by Django 4.0.2 on 2022-07-06 11:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Waste',
            fields=[
                ('id', models.CharField(default='icSutDfACHxUNnB', max_length=15, primary_key=True, serialize=False, unique=True)),
                ('entry_date', models.DateField(default=datetime.datetime(2022, 7, 6, 11, 54, 14, 982488, tzinfo=utc))),
